...
#ifndef __AI_PNET_H__
#define __AI_PNET_H__
#pragma once

#include "ai_platform.h"

#define AI_PNET_MODEL_NAME          "pnet"

#define AI_PNET_IN_NUM       (1)
#define AI_PNET_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 27, 27, 3, 1, NULL), \
}
#define AI_PNET_IN_SIZE { \
  (27 * 27 * 3), \
}
#define AI_PNET_IN_1_SIZE  (27 * 27 * 3)
#define AI_PNET_IN_1_SIZE_BYTES  ((27 * 27 * 3) * 4)




#define AI_PNET_OUT_NUM      (1)
#define AI_PNET_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 8, 8, 2, 1, NULL), \
}
#define AI_PNET_OUT_SIZE { \
  (8 * 8 * 2), \
}
#define AI_PNET_OUT_1_SIZE  (8 * 8 * 2)
#define AI_PNET_OUT_1_SIZE_BYTES  ((8 * 8 * 2) * 4)
 ...
 * @ref ai_pnet_create. Both the activations memory buffer 
 ...
 * header generated by the code generation tool. See AI_PNET_*
 * defines into file @ref pnet.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
