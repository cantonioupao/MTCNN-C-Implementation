...
#define AI_PNET_MODEL_SIGNATURE     "b606396c1ec5314b46515d19d1f93c98"
...
#define AI_TOOLS_DATE_TIME   "Mon Jun  1 01:24:26 2020"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0, AI_SHAPE_INIT(4, 1, 10, 10, 2), AI_STRIDE_INIT(4, 4, 4, 40, 400),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0, AI_SHAPE_INIT(4, 1, 10, 5, 5), AI_STRIDE_INIT(4, 4, 4, 40, 200),
  1, &conv1_output_array, NULL)
AI_TENSOR_OBJ_DECLARE(
  conv2_output, AI_STATIC,
  0x0, 0x0, AI_SHAPE_INIT(4, 1, 16, 3, 3), AI_STRIDE_INIT(4, 4, 4, 64, 192),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8,
                     1, 1, 1800, 1,
                     NULL),
  AI_TENSOR_LIST_IO_ENTRY(AI_FLAG_NONE, AI_PNET_IN_NUM, &input_1_output),
  ...
  ai_network* net_ctx, const ai_buffer* activation_buffer)
{
...

  {
    ...
    conv1_output_array.data = AI_PTR(activations + 800);
    conv1_output_array.data_start = AI_PTR(activations + 800);
    conv2_output_array.data = AI_PTR(activations + 0);
    conv2_output_array.data_start = AI_PTR(activations + 0);
    conv3_output_array.data = AI_PTR(activations + 576);
    conv3_output_array.data_start = AI_PTR(activations + 576);
