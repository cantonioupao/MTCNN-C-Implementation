...
#define AI_PNET_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 12, 12, 3, 1, NULL), \
}
#define AI_PNET_IN_SIZE { \
  (12 * 12 * 3), \
}
#define AI_PNET_IN_1_SIZE  (12 * 12 * 3)
#define AI_PNET_IN_1_SIZE_BYTES  ((12 * 12 * 3) * 4)
...
#define AI_PNET_OUT_1_SIZE  (1 * 1 * 2)
#define AI_PNET_OUT_1_SIZE_BYTES  ((1 * 1 * 2) * 4)
