...
#ifndef __AI_ONET_H__
#define __AI_ONET_H__
#pragma once

#include "ai_platform.h"

#define AI_ONET_MODEL_NAME          "onet"

#define AI_ONET_IN_NUM       (1)
#define AI_ONET_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 48, 48, 3, 1, NULL), \
}
#define AI_ONET_IN_SIZE { \
  (48 * 48 * 3), \
}
#define AI_ONET_IN_1_SIZE  (48 * 48 * 3)
#define AI_ONET_IN_1_SIZE_BYTES  ((48 * 48 * 3) * 4)




#define AI_ONET_OUT_NUM      (1)
#define AI_ONET_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 4, 1, NULL), \
}
#define AI_ONET_OUT_SIZE { \
  (1 * 1 * 4), \
}
#define AI_ONET_OUT_1_SIZE  (1 * 1 * 4)
#define AI_ONET_OUT_1_SIZE_BYTES  ((1 * 1 * 4) * 4)
 ...
 * @ref ai_onet_create. Both the activations memory buffer 
 ...
 * header generated by the code generation tool. See AI_ONET_*
 * defines into file @ref onet.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
